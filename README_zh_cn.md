...
- **目前发现存在被滥用的情况，暂时限制最大帧率到240**

- **这个repo魔改自34736384的[unlocker](https://github.com/34736384/genshin-fps-unlock) 的旧版本**

# -----------------------------------------------------------------
 - 工作原理通过**WriteProcessMemory**把代码写进游戏
 - 不需要通过驱动进行读写操作
 - 支持国服和外服
 - 理论上支持后续版本，不需要更新源码
 - 如果需要更新我会尽快更新
 - 如果不想手动编译的话去[Release](https://github.com/winTEuser/Genshin_StarRail_fps_unlocker/releases)下载编译好的
# -----------------------------------------------------------------
## 自定义参数启动
